# CLAUDE.md — awesome-nano-banana-pro-prompts

Nach Use-Case sortierte **Prompt-Bibliothek** für Nano Banana Pro (Profile/Avatar,
Social/Thumbnail/Infographic, Comic, Product u. v. m.). Quelle für den Skill
`nano-banana-pro`. **Die README-Dateien werden per GitHub-Action auto-generiert**
— nicht von Hand editieren; diese CLAUDE.md ist die stabile Ablage.
